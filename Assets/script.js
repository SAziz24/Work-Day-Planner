...
function showTodayPlanner() {
    ...
    <button type="button" class="btn col-1 saveBtn" id="saveBtn${i}" data-button id="${i}"><i class="fas fa-save" data-button id="${i}"></i></button>
    </div>
    `);
...
/*
Initialization (Loading page/ refresh)
*/
